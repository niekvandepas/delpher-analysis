...
def classify_articles_dutch(texts: list[PlainTextSearchResult]) -> list[OllamaClassificationResult]:
    ...
    Hier is een voorbeeld ter begeleiding van je classificatie:
    ...
    Hier is nog een voorbeeld ter begeleiding van je classificatie:
